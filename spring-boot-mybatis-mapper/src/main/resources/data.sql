...
insert  into `peoson`(`name`,`age`,`address`) values('AAA',18,'shenzhen');
insert  into `peoson`(`name`,`age`,`address`) values('BBB',19,'changsha');
insert  into `peoson`(`name`,`age`,`address`) values('CCC',20,'wuhan');
insert  into `peoson`(`name`,`age`,`address`) values('DDD',21,'shenzhen');
insert  into `peoson`(`name`,`age`,`address`) values('EEE',22,'shenzhen');
insert  into `peoson`(`name`,`age`,`address`) values('FFF',23,'wuhan');
insert  into `peoson`(`name`,`age`,`address`) values('GGG',18,'wuhan');
insert  into `peoson`(`name`,`age`,`address`) values('HHH',19,'changsha');
insert  into `peoson`(`name`,`age`,`address`) values('JJJ',20,'wuhan');
insert  into `peoson`(`name`,`age`,`address`) values('KKK',22,'shenzhen');
insert  into `peoson`(`name`,`age`,`address`) values('LLL',24,'changsha');
insert  into `peoson`(`name`,`age`,`address`) values('MMM',34,'wuhan');
insert  into `peoson`(`name`,`age`,`address`) values('NNN',37,'shenzhen');
